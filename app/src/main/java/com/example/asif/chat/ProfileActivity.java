                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.hasChild(user_id)) {
                            ...
                            if (req_type.equals("recieved")) {
                                ...
                                mCurrent_state = 2;
                                mProfileSendReqBtn.setText("Accept Autherization request");
                                ...
                                mCurrent_state = 1;
                                mProfileSendReqBtn.setText("Cancel Autherization request");
                            ...
                            mFriendsdb.child(mCurrentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    if(dataSnapshot.hasChild(user_id)){
                                        mCurrent_state = 3;
                                        mProfileSendReqBtn.setText("UnAuthorize");
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                                    ...
                                                    public void onSuccess(Void aVoid) {
                                                        ...
                                                        mNotificationsdb.child(user_id).push()
                                                            ...
                                                            public void onSuccess(Void aVoid) {
                                                                ...
                                                                mProfileSendReqBtn.setText("Cancel Authorization");
                                                                Toast.makeText(getApplicationContext(),"Authorization Request Sent",Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(getApplicationContext(),"Error Sending Authorization Request",Toast.LENGTH_SHORT).show();
                                    }
                                }
                    }       );
                }
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    if(task.isSuccessful()) {
                                                        mCurrent_state = 0;
                                                        mProfileSendReqBtn.setEnabled(true);
                                                        mProfileSendReqBtn.setText("Send Authorization Request");

                                                        mDeclineBtn.setVisibility(View.INVISIBLE);
                                                        mDeclineBtn.setEnabled(false);

                                                        Toast.makeText(getApplication(), "Authorization Request cancelled", Toast.LENGTH_SHORT).show();
                                                    }
                                                    else {
                                                        Toast.makeText(getApplication(), "Error cancelling Authorization Request ", Toast.LENGTH_SHORT).show();
                                                    }
                                                    }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                                                        ...
                                                                        mFriendRequestdb.child(user_id).child(mCurrentUser.getUid()).removeValue()
                                                                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                    ...
                                                                                    public void onSuccess(Void aVoid) {
                                                                                        ...
                                                                                        mProfileSendReqBtn.setEnabled(true);
                                                                                        mProfileSendReqBtn.setText("UnAuthorize");
                                                                                        Toast.makeText(getApplication(), "Authorization Request Accepted", Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(getApplication(), "Error Accepting Authorization Request ", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
