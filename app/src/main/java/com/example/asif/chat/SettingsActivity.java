...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button mchange_photo, mchange_status,mchange_location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mchange_location = (Button) findViewById( R.id.change_location);
        ...
        mchange_location.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.change_location){
            Intent LocSetngs = new Intent(SettingsActivity.this,LocationSettings_Activity.class);
            LocSetngs.putExtra("currenUser",uid);
            startActivity(LocSetngs);
        }
