...
public class RegisterActivity extends AppCompatActivity {
    ...
    private TextInputEditText Uname,Email,Password,Phone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!TextUtils.isEmpty(name) ||!TextUtils.isEmpty(mail) ||!TextUtils.isEmpty(pass) ||!TextUtils.isEmpty(phn))  {
                    progressDialog.setTitle("Creating new account");
                    progressDialog.setMessage("Please Wail wait");
                    progressDialog.setCanceledOnTouchOutside(false);
                    progressDialog.show();
                    register_user(name, mail, pass,phn);
                }
            }
        });
    }

    private void register_user(final String name, String mail, String pass, final String phn) {
                    ...
                    db.setValue(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                        ...
                                        db.child("Loc").child("ping").setValue(0);
